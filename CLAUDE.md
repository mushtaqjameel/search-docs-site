...
- **content/** - MDX content pages
  - `index.mdx` - Homepage
  - `features.mdx` - Feature explorer (count derived from data/features.json)
...
- Features loaded from data/features.json
- Three pillar ratings (data, governance, safety)
- Filtering and search by bucket
- Expandable detail cards

## Key Concepts

- **6 Buckets**: Core Search, AI Search, Discovery, Merchandising, Recovery, Analytics (counts in data/buckets.json)
