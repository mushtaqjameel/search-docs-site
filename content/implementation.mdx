...
<Tabs items={['Data Matrix', 'Investment', 'Phasing', 'Remediation']}>
  ...
  <Tabs.Tab>
    ...
    | :--- | :--- | :--- | :--- |
    | **Auto Complete** | Basic Catalog | <span className="px-2 py-1 rounded text-xs font-bold bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300">Low</span> | ✅ Yes |
    | **Faceted Search** | Rich Catalog (Attributes) | <span className="px-2 py-1 rounded text-xs font-bold bg-yellow-100 text-yellow-700 dark:bg-yellow-900 dark:text-yellow-300">Medium</span> | ⚠️ If attributes exist |
    | **Semantic Search** | Rich Catalog (Descriptions) | <span className="px-2 py-1 rounded text-xs font-bold bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-300">High</span> | ⚠️ Quality = Desc quality |
    | **Intelligent Synonyms** | Behavioral Data | <span className="px-2 py-1 rounded text-xs font-bold bg-yellow-100 text-yellow-700 dark:bg-yellow-900 dark:text-yellow-300">Medium</span> | ❌ Needs 30+ days |
    | **ML Ranking** | Behavioral + Transactional | <span className="px-2 py-1 rounded text-xs font-bold bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-300">High</span> | ❌ Needs 90+ days |
    | **Recommendations** | Behavioral + Trans + User | <span className="px-2 py-1 rounded text-xs font-bold bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-300">High</span> | ⚠️ Can bootstrap rules |
    | **Cross-Brand Equiv** | Relationship Data | <span className="px-2 py-1 rounded text-xs font-bold bg-yellow-100 text-yellow-700 dark:bg-yellow-900 dark:text-yellow-300">Medium</span> | ⚠️ If cross-refs exist |
    | **Recently Ordered** | User + Transactional | <span className="px-2 py-1 rounded text-xs font-bold bg-yellow-100 text-yellow-700 dark:bg-yellow-900 dark:text-yellow-300">Medium</span> | ✅ If history accessible |
    | **Curations** | Basic Catalog | <span className="px-2 py-1 rounded text-xs font-bold bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300">Low</span> | ✅ Yes |
    | **Analytics** | Behavioral Data | <span className="px-2 py-1 rounded text-xs font-bold bg-yellow-100 text-yellow-700 dark:bg-yellow-900 dark:text-yellow-300">Medium</span> | ✅ Value grows over time |
  ...
  <Tabs.Tab>
    ...
    | :--- | :--- | :--- | :--- |
    | **⭐ Critical** | <span className="px-2 py-1 rounded text-xs font-bold bg-purple-100 text-purple-700">PREMIUM</span> | <span className="px-2 py-1 rounded text-xs font-bold bg-cyan-100 text-cyan-700">POLISHED</span> | <span className="px-2 py-1 rounded text-xs font-bold bg-cyan-100 text-cyan-700">POLISHED</span> |
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
        <div className="border-l-4 border-emerald-500 pl-4 py-2 bg-neutral-50 dark:bg-neutral-900">
            ...
            <ul className="list-disc pl-5 text-sm space-y-1">
                <li><strong>Auto Complete</strong> — Titles and SKUs</li>
                <li><strong>Part Number Normalization</strong> — Pattern matching</li>
                <li><strong>Basic Facets</strong> — Category/brand filtering</li>
                <li><strong>Search Sandbox</strong> — Testing tool</li>
                <li><strong>Curations</strong> — Manual merchandising</li>
                <li><strong>Configuration Management</strong> — Settings control</li>
            </ul>
        </div>
        ...
        <div className="border-l-4 border-yellow-400 pl-4 py-2 bg-neutral-50 dark:bg-neutral-900">
            ...
            <ul className="list-disc pl-5 text-sm space-y-1">
                <li><strong>Analytics Dashboard</strong> — Search insights</li>
                <li><strong>Trending Search</strong> — Popular queries</li>
                <li><strong>Related Searches</strong> — Query suggestions</li>
                <li><strong>Zero Results Recovery</strong> — Better with patterns</li>
                <li><strong>Query Behaviour Labeller</strong> — Pattern analysis</li>
            </ul>
        </div>
        ...
        <div className="border-l-4 border-orange-500 pl-4 py-2 bg-neutral-50 dark:bg-neutral-900">
            ...
            <ul className="list-disc pl-5 text-sm space-y-1">
                <li><strong>Intelligent Synonyms</strong> — Learned mappings</li>
                <li><strong>Semantic Search</strong> — Better with enriched content</li>
                <li><strong>A/B Testing</strong> — Needs traffic volume</li>
                <li><strong>Fallback Search</strong> — Tuned to patterns</li>
            </ul>
        </div>
  ...
  <Tabs.Tab>
    ...
    <DiagramWithHelp
      ...
      introduction="Critical for AI-assisted content generation. Shows how generated content flows through confidence-based routing to appropriate approval queues. The feedback loop ensures continuous improvement."
      example={{
        title: "Electrical Components Catalog Enrichment",
        context: "25,000 SKUs need descriptions. AI generates, humans validate.",
        steps: [
          { action: "AI generates descriptions from images + specs", outcome: "Content created for all 25k products", result: "green" },
          { action: "High confidence (18k items, 72%)", outcome: "Auto-approved, spot-check 5% sample", result: "green" },
          { action: "Medium confidence (5k items, 20%)", outcome: "Human review queue - 2-3 min each", result: "yellow" },
          { action: "Low confidence (2k items, 8%)", outcome: "AI draft as starting point, human rewrite", result: "red" },
          { action: "Feedback loop", outcome: "Edits improve future generations", result: "green" }
        ],
        conclusion: "Estimate: 18k auto-approved in day 1. 5k need ~200 review hours over 2 weeks. 2k need dedicated writing time. Total: 3-4 weeks for full catalog."
      }}
    >
      <Mermaid chart={`
      flowchart TD
      subgraph GENERATE["🤖 AI GENERATION"]
          direction LR
          INPUT[Product Data<br>Images, Specs, Titles] --> GEN[AI Model]
          GEN --> OUTPUT[Generated Content<br>Descriptions, Attributes]
      end

      OUTPUT --> SCORE{Confidence<br>Score?}

      subgraph HIGH["✅ HIGH CONFIDENCE (85%+)"]
          SCORE -->|High| AUTO_Q[Auto-approve Queue]
          AUTO_Q --> SPOT[Spot Check<br>Sample 5-10%]
          SPOT -->|OK| PUBLISH_H[Publish]
          SPOT -->|Issues| FLAG[Flag for<br>Model Review]
      end

      subgraph MEDIUM["🟡 MEDIUM CONFIDENCE (60-85%)"]
          SCORE -->|Medium| REVIEW_Q[Human Review Queue]
          REVIEW_Q --> REVIEWER{Reviewer<br>Action?}
          REVIEWER -->|Approve| PUBLISH_M[Publish]
          REVIEWER -->|Edit| EDIT[Edit + Publish]
          REVIEWER -->|Reject| REGEN[Regenerate<br>or Manual]
      end

      subgraph LOW["🔴 LOW CONFIDENCE (<60%)"]
          SCORE -->|Low| MANUAL_Q[Manual Queue]
          MANUAL_Q --> DRAFT[AI Draft as<br>Starting Point]
          DRAFT --> REWRITE[Human Rewrite]
          REWRITE --> PUBLISH_L[Publish]
      end

      subgraph FEEDBACK["📊 FEEDBACK LOOP"]
          PUBLISH_H --> METRICS[Track Quality<br>Metrics]
          PUBLISH_M --> METRICS
          EDIT --> METRICS
          PUBLISH_L --> METRICS
          METRICS --> IMPROVE[Improve Model<br>Thresholds]
          IMPROVE --> GEN
      end

      style GENERATE fill:#E3F2FD,stroke:#2196F3
      style HIGH fill:#E8F5E9,stroke:#4CAF50
      style MEDIUM fill:#FFF9E6,stroke:#FF9800
      style LOW fill:#FFEBEE,stroke:#F44336
      style FEEDBACK fill:#F3E5F5,stroke:#9C27B0
      `} />
    </DiagramWithHelp>

    <Callout type="info" emoji="👥">
        **Capacity Planning:** Budget 2-5 minutes per medium-confidence item for human review. High-volume catalogs (100k+ products) may need staged rollout or dedicated review team.
    </Callout>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
        <div className="p-4 rounded-lg bg-green-50 dark:bg-green-900/20 border border-green-100 dark:border-green-800">
            ...
            <ul className="list-disc pl-5 text-sm space-y-2">
                <li><strong>Product descriptions</strong> — From images + titles + specs</li>
                <li><strong>Attribute extraction</strong> — From unstructured text</li>
                <li><strong>Category suggestions</strong> — From product content</li>
                <li><strong>Search keywords</strong> — Synonyms and variants</li>
                <li><strong>Short descriptions</strong> — Summaries from long content</li>
            </ul>
        </div>
        <div className="p-4 rounded-lg bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-800">
            ...
            <ul className="list-disc pl-5 text-sm space-y-2">
                <li><strong>Pricing</strong> — Business data</li>
                <li><strong>Inventory levels</strong> — Real-time data</li>
                <li><strong>Cross-references</strong> — Requires industry knowledge</li>
                <li><strong>Order history</strong> — Transactional data</li>
                <li><strong>User behavior</strong> — Must be collected</li>
            </ul>
        </div>
    </div>
