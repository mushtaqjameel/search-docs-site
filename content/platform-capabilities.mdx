...
import { FeatureCount } from '../components/Counts'
...
For client-facing feature discussions, focus on the [<FeatureCount /> Search Features](/features) instead.
